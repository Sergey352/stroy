...
# -*- coding: utf-8 -*-
"""
Проверяет, что в форме 2455896 у полей проставлены коды (code) именно так,
как указано в «Спецификация формы Pyrus - Снабжение.docx» (раздел 3).
Без этого остальные скрипты (create_request_example.py, боты) работать
не смогут — они обращаются к полям по коду, а не по id/названию.
...
EXPECTED_CODES = {
    "object": "Объект",
    "area": "Участок / этаж / зона",
    "material_category": "Категория материала",
    "items_table": "Позиции заявки (таблица)",
    "item_description": "Номенклатура / описание",
    "unit": "Единица измерения",
    "quantity": "Количество",
    "budget_remainder": "Остаток по смете",
    "budget_cost": "Стоимость по смете",
